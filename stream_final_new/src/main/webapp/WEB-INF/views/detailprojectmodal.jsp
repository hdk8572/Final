			...
			<div class="modal-body addProject">
				<div class="wrap-card">
					...
					<div class="card-header addProjectTitle">
						<h2 class="addProjectTitle"><b>asd프로젝트 등록</b></h2>
					</div>
						<form class="detail-project">					
						...
						<br>
						<textarea class="form-control detail-content" id="summernote" rows="10" name="pcontent" placeholder="프로젝트에 관한 설명을 입력해주세요"></textarea>
						<br>
