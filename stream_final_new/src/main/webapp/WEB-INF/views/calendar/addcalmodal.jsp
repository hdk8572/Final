...
<!-- ATTENUSERID -->
						...
						<span class="d-flex align-items-center">
							...
							<div>
								...
								<input type= "text" class= "form-control manager ml-2" name="tmember" placeholder= "참석자 추가">
								<div class="cal-attenuserId col-lg-1" id="clist">${task.tstatus }</div>
								<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0 show" aria-labelledby="messagesDropdown" data-bs-popper="none"></div>
							</div>
						</span>
						</div>
						<br>
					...
					<textarea class="form-control content" name="pcoment" placeholder="내용을 입력해주세요."></textarea>
						...
						<script>
					      ClassicEditor.create(document.querySelector(".ptask .form-control.content"), {
					    	  language: "ko"
					      });
					    </script>
				</div>
