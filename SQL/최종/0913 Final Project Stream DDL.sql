...
ALTER TABLE "MEMBER_SCHEDULE" ADD CONSTRAINT "FK_SCHEDULE_TO_MEMBER_SCHEDULE_1" FOREIGN KEY (
	"SNO"
)
REFERENCES "SCHEDULE" (
	"SNO"
...
ALTER TABLE "MEMBER_SCHEDULE" ADD CONSTRAINT "FK_USERS_TO_MEMBER_SCHEDULE_1" FOREIGN KEY (
	"ATTENUSERID"
)
REFERENCES "USERS" (
	"USERID"
