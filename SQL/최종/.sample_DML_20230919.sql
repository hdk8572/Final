...
INSERT INTO PROJECT ( PNO, USERID, PNAME, PCOMENT, PACCESS, PDATE, PSTARTDATE, PENDDATE, PSTATUS)
VALUES (project_sequence.NEXTVAL, 'fffll@ctest.co.kr', 'PNAME자리', 'PCOMENT자리', 'ACCESS', TO_DATE('2023-09-12', 'YYYY-MM-DD'), TO_DATE('2023-09-13', 'YYYY-MM-DD'), TO_DATE('2023-10-11', 'YYYY-MM-DD'), '진행');

INSERT INTO PROJECT ( PNO, USERID, PNAME, PCOMENT, PACCESS, PDATE, PSTARTDATE, PENDDATE, PSTATUS)
VALUES (project_sequence.NEXTVAL, 'react@ctest.co.kr', 'PNAME자리입니다', 'PCOMENT자리입니다', 'ACCESS', TO_DATE('2023-09-12', 'YYYY-MM-DD'), TO_DATE('2023-09-13', 'YYYY-MM-DD'), TO_DATE('2023-10-11', 'YYYY-MM-DD'), '진행');
