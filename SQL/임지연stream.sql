...
select userid, ( select mname from users tu where tm.userid=tu.userid ) from MEMBER_PROJECT tm where pno='1'; 

select userid, ( select mname from users tu where tm.userid=tu.userid ) attenduser from MEMBER_PROJECT tm where pno=#{pno}; 
